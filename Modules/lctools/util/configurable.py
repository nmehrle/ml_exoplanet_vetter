...
#
"""
Base class for configurable objects allowing child classes to be passed
either a configuration structure which assumes two level deep dictionary
content, or the original arguments for the classes construction as either
key word args (**kwargs) or as regular arguments list (*args)
"""
...
class Configuration(configobj.ConfigObj):
    def __init__(self, filename=None):
        ...
        """
        logging.info("reading configuration from %s" % filename)
...
class ConfigurableObject(object):
    ...
    Class 'A' in this case would capture arguments from {'A': {...}, 'B': {...'}}
